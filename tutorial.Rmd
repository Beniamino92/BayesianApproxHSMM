...
---
This R markdown file is part of the supplementary material to the paper 'Bayesian Approximation of Hidden Semi-Models' (2020) by B.Hadj-Amar, J.Jewson and M.Fiecas. 

Here, we generate data from a three state HSMM with Gaussian emission and Poisson dwell durations. 
Estimation procedures are carried out using both frequentist (EM) and Bayesian approaches, where
we validate each model using several diagnostic tools. We also illustrate the use of Bayes factors for model selection between the proposed approach and the HMM.
---
