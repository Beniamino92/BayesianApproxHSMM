...
K <- 3
m.3 <- m
EM.3 <- HSMM.ECM.geom(K, m.3, obs, parms_init, niter = 3e2)
...
EM.3_pseudo_residuals <- HSMM.pseudo_residuals.geom(obs, m.3, EM.3$theta_simplex_vec, 
                      EM.3$mu, EM.3$sigma, EM.3$gamma, plt = TRUE)
EM.3_viterbi <- HSMM.viterbi.geom(obs, m.3, EM.3$theta_simplex_vec, EM.3$mu, EM.3$sigma, EM.3$gamma, plt = TRUE)
...
EM.2m1_pseudo_residuals <- HSMM.pseudo_residuals.geom(obs = data, m.2m1, EM.2m1$theta_simplex_vec, 
                      EM.2m1$mu, EM.2m1$sigma, EM.2m1$gamma, plt = TRUE)
EM.2m1_viterbi <- HSMM.viterbi.geom(obs = data, m.2m1, EM.2m1$theta_simplex_vec, EM.2m1$mu, EM.2m1$sigma, EM.2m1$gamma, plt = TRUE)
...
EM.2m2_pseudo_residuals <- HSMM.pseudo_residuals.geom(obs = data, m.2m2, EM.2m2$theta_simplex_vec, 
                      EM.2m2$mu, EM.2m2$sigma, EM.2m2$gamma, plt = TRUE)
EM.2m2_viterbi <- HSMM.viterbi.geom(obs = data, m.2m2, EM.2m2$theta_simplex_vec, EM.2m2$mu, EM.2m2$sigma, EM.2m2$gamma, plt = TRUE)
