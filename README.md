...
extra flexibility afforded by our proposed methodology to investigate departures from the HMM. Finally, `case_study_frequncy.jl` illustrates the use of our Metropolis-within-Gibbs sampler to estimate the frequency that drives the overall variation in the physical activity time series. 
